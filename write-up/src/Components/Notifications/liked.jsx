...
:
        ...
        <img src={notification.message[0].user[2].public_picture} alt={notification.message[0].user[0].name} className='h-[3em] w-[3em] m-auto lg:mt-[1em] rounded-full' />
        
        <p className=" relative m-auto z-0 left-[1em] lg:left-[-1.5em] lg:top-3 -top-10 text-red-600 text-3xl">💖</p>
        <div className=' w-[70%] font-[Outfit] m-auto lg:ml-[2em]'>
