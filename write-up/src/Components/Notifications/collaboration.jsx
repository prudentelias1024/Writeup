...
const Collaboration = ({notification}) => {
    ...
    return (
        <Link to={notification.message[0].post[1].link}>
            <div className='flex flex-row lg:flex-row  lg:border-[.4px] gap-3  w-[115%] border-b-[1px] border-t-[1px] lg:w-[60%] bg-white dark:bg-[#000] dark:border-[#515151] dark:text-white p-[.5em]   lg:pl-[2em] hover:scale-110'>
