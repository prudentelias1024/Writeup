...
const Bookmarked = ({notification}) => {
    ...
    return (
        <div>
        <div className='flex flex-row lg:flex-row gap-3 lg:border-[.4px]  w-[115%] border-b-[1px] border-t-[1px] lg:w-[60%] dark:border-[#515151] bg-white dark:bg-[#000] dark:text-white p-[.5em]   lg:pl-[2em] '>
