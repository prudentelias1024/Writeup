...
const DashboardPosts = () => {
    return (
        ...
        <div className='flex flex-col'>
            <Link className="text-[#3b49df] text-xl w-full px-4 leading-8 lg:text-2xl font-bold font-[Mulish]" to="/dashboard">How to Become a React, Angular, Node.js Developer</Link>
