...
export default function SideNavBar(){
  ...
  useEffect(
    ...
    return(
        <div ref={navRef} className=" lg:bg-[#f6f6f6] hidden overflow-y-auto absolute  pt-[8em] w-full  text-center  z-30  pl-[0em]  bg-white lg:flex lg:flex-col lg:gap-4 lg:ml-32  lg:mt-32 lg:p-2 lg:h-[60em] lg:w-[15em] lg:relative ">
